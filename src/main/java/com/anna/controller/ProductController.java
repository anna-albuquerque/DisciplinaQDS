...
public class ProductController {
	...
	public void addProduct(int productId, String name, double price, int stockQuantity) {
		...
		Product product = new Product(productId, name, BigDecimal.valueOf(price), stockQuantity); // Converta
																									// price
																									// para
																									// BigDecimal
	...
	public void listProducts() {
		...
		for (Product product : products) {
			System.out.println("ID: " + product.getProductId() + ", Nome: " + product.getName() + ", Preço: $"
					+ product.getPrice() + ", Estoque: " + product.getStockQuantity());
		}
	}
	...
	public void updateProduct(int productId, String newName, double newPrice, int newStockQuantity) {
		...
		for (Product product : products) {
			if (product.getProductId() == productId) {
				...
				product.setPrice(BigDecimal.valueOf(newPrice)); // Converta newPrice para
																// BigDecimal
